...
instance ByteSize Int where
  byteSize _ = Just $ finiteBitSize (0 :: Int) `div` 8

instance ByteSize Int8 where
  byteSize _ = Just $ finiteBitSize (0 :: Int8) `div` 8

instance ByteSize Int16 where
  byteSize _ = Just $ finiteBitSize (0 :: Int16) `div` 8

instance ByteSize Int32 where
  byteSize _ = Just $ finiteBitSize (0 :: Int32) `div` 8

instance ByteSize Int64 where
  byteSize _ = Just $ finiteBitSize (0 :: Int64) `div` 8
